...
<activation critical="MANDATORY">
  ...
  <step n="4">Load config: {project-root}/bmad/teachflow/config.yaml and set all variables</step>
  ...
  <menu>
    ...
    <item cmd="*incident" workflow="{project-root}/bmad/teachflow/workflows/behavior-incident-report/workflow.yaml">Document behavior incident with factual details</item>
    <item cmd="*parent-email" workflow="{project-root}/bmad/teachflow/workflows/parent-communication/workflow.yaml">Draft professional parent communication</item>
    <item cmd="*management-plan" workflow="{project-root}/bmad/teachflow/workflows/classroom-management-plan/workflow.yaml">Create classroom management strategies</item>
    <item cmd="*interventions" workflow="{project-root}/bmad/teachflow/workflows/intervention-strategies/workflow.yaml">Get behavior intervention recommendations</item>
    <item cmd="*patterns" workflow="{project-root}/bmad/teachflow/workflows/behavior-pattern-analysis/workflow.yaml">Analyze behavioral trends across incidents</item>
    <item cmd="*progress-report" workflow="{project-root}/bmad/teachflow/workflows/behavior-progress-report/workflow.yaml">Generate behavior improvement reports</item>
